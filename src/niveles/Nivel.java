...
public abstract class Nivel {
	...
	protected String claveMusica;
	protected String claveMusicaBoss;
	...
	public Nivel(Juego juego) {
		...
		this.claveMusica = clase;
		this.claveMusicaBoss = clase+"_Boss";
	...
	public String getClaveMusica() {
		return claveMusica;
	}
	
	public String getClaveMusicaBoss() {
		return claveMusicaBoss;
	}
