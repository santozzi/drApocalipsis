...
public class Juego implements IObservado {
	...
	public void cargarNivel() {
		...
		if(nivel!=null) {
			...
			musica.parar();
			musica.reproducir(nivel.getClaveMusica());
		}
	...
	public void cargarJefe() {
		...
		musica.parar();
		musica.reproducir(nivel.getClaveMusicaBoss());
	...
	public void suspenderHiloSecundario() {
		if(hiloSecundario.isAlive()) {
			hiloSecundario.interrupt();
			hiloSecundario.suspend();
		}
	}

	public void reanudarHiloSecundario() {
		if(hiloSecundario.isAlive())
			hiloSecundario.resume();
	}
	/**
	...
	public Musica getReproductorDeMusica() {
		return musica;
	}
	public Ambiente getReproductorDeSonidoAmbiental() {
		return ambiente;
	}
	public SonidoFX getReproductorDeEfectosDeSonido() {
		return sonidoFX;
	}
